...
MissionRegObject( Stations, "Jet", MissionCreateObject, JetStation, StaticShape, JetStation );
MissionRegObject( Stations, "Jet Pad", MissionCreateObject, JetPad, StaticShape, JetPad);
MissionRegObject( Stations, "Chopper", MissionCreateObject, ChopperStation, StaticShape, ChopperStation );
MissionRegObject( Stations, "Chopper Pad", MissionCreateObject, ChopperPad, StaticShape, ChopperPad);
MissionRegObject( Stations, "Tank", MissionCreateObject, TankStation, StaticShape, TankStation );
MissionRegObject( Stations, "Tank Pad", MissionCreateObject, TankPad, StaticShape, TankPad);
...
MissionRegObject( Turrets, "20mm Cannon",  MissionCreateObject, plasmaTurret, Turret, plasmaTurret );
MissionRegObject( Turrets, "Indoor Machine Gun",  MissionCreateObject, indoorTurret, Turret, indoorTurret );
MissionRegObject( Turrets, "Howitzer",  MissionCreateObject, mortarTurret, Turret, mortarTurret );
MissionRegObject( Turrets, "SAM Emplacement",  MissionCreateObject, rocketTurret, Turret, rocketTurret );
MissionRegObject( Turrets, "AA Flak Gun", MissionCreateObject, flakTurret, Turret, flakTurret);
...
MissionRegObject( Vehicles, "Falcon", MissionCreateObject, Fighter, Flier, Fighter );
//MissionRegObject( Vehicles, "Stuka", MissionCreateObject, DiveBomber, Flier, DiveBomber );
MissionRegObject( Vehicles, "Tomcat", MissionCreateObject, Fighter2, Flier, Fighter2 );
MissionRegObject( Vehicles, "Warthog", MissionCreateObject, Warthog, Flier, Warthog );
MissionRegObject( Vehicles, "B-52 Stratofortress", MissionCreateObject, Bomber, Flier, Bomber);
MissionRegObject( Vehicles, "C-130 Hercules", MissionCreateObject, Hercules, Flier, Hercules);
MissionRegObject( Vehicles, "AC-130U Gunship", MissionCreateObject, Gunship, Flier, Gunship);
MissionRegObject( Vehicles, "Apache", MissionCreateObject, Apache, Flier, Apache );
MissionRegObject( Vehicles, "Mi-24 Hind", MissionCreateObject, Hind, Flier, Hind);
MissionRegObject( Vehicles, "Blackhawk", MissionCreateObject, Blackhawk, Flier, Blackhawk );
MissionRegObject( Vehicles, "HMMWV", MissionCreateObject, Humvee, Flier, Humvee );
MissionRegObject( Vehicles, "M1 Abrams MBT", MissionCreateObject, Abrams, Flier, Abrams);
MissionRegObject( Vehicles, "M113 APC", MissionCreateObject, Bradley, Flier, Bradley);
MissionRegObject( Vehicles, "MLRS Launcher", MissionCreateObject, MLRS, Flier, MLRS);
MissionRegObject( Vehicles, "M6 Bradley LB", MissionCreateObject, LineBacker, Flier, LineBacker);
MissionRegObject( Vehicles, "M548A3 W/ Volcano", MissionCreateObject, MineLayer, Flier, MineLayer);
...
// DELTA FORCE
MissionRegItem( Weapons, "SOCOM Pistol", SOCOM, 1);
MissionRegItem( Weapons, "OICW Rifle", OICW, 1);
MissionRegItem( Weapons, "M249 SAW", SAW, 1);
MissionRegItem( Weapons, "Silenced MP5", MP5, 1);
MissionRegItem( Weapons, "Automatic Shotgun", AutoShotgun, 1);
MissionRegItem( Weapons, "LAW", LAW, 1);
MissionRegItem( Weapons, "Flamethrower", Flamethrower, 1);
MissionRegItem( Weapons, "Stinger", Stinger, 1);
MissionRegItem( Weapons, "Howitzer", Howitzer, 1);
MissionRegItem( Weapons, "Airstrike Designator", Airstrike, 1);
// END DELTA FORCE
...
MissionRegItem( Ammo, "M14 AP Mines", APMinePack, 2 );
MissionRegItem( Ammo, "Hand Grenades", Grenade, 5);
// DELTA FORCE
MissionRegItem( Ammo, "SOCOM Clip", SOCOMAmmo, 20);
MissionRegItem( Ammo, "OICW Clip", OICWAmmo, 50);
MissionRegItem( Ammo, "SAW Belt", SAWAmmo, 50);
MissionRegItem( Ammo, "Shotgun Shells", AutoShotgunAmmo, 25);
MissionRegItem( Ammo, "MP5 Clip", MP5Ammo, 50);
MissionRegItem( Ammo, "LAW Rounds", LAWAmmo, 5);
MissionRegItem( Ammo, "Flame Ammo", FlameAmmo, 25);
MissionRegItem( Ammo, "Stinger Missiles", StingerAmmo, 1);
MissionRegItem( Ammo, "Howitzer Shells", HowitzerAmmo, 5);
// END DELTA FORCE
...
MissionRegItem( Packs, "Parachute", Parachute, 1);
MissionRegItem( Packs, "Repair Toolkit", RepairPack, 1);
MissionRegItem( Packs, "Medikit", MedicPack, 1);
...
MissionRegObject( Sensors, "Remote Radar Sensor", MissionCreateObject, RmtPulse, Sensor, DeployablePulseSensor );
MissionRegObject( Sensors, "Radar Sensor", MissionCreateObject, Sensor, Sensor, PulseSensor );
MissionRegObject( Sensors, "Medium Radar Sensor", MissionCreateObject, MedPulse, Sensor, MediumPulseSensor );
