$Server::teamName[0] = "Delta Force";
$Server::teamSkin[0] = "beagle";
$Server::teamName[1] = "Marine Force Recon";
$Server::teamSkin[1] = "dsword";
$Server::teamName[2] = "SEAL";
$Server::teamSkin[2] = "cphoenix";
$Server::teamName[3] = "U.S. Rangers";
...
$Server::HostName = "DeltaForce TRIBES Server";
...
$Server::Info = "Default DeltaForce TRIBES server setup\nAdmin: Unknown\nEmail: Unknown";
$Server::JoinMOTD = "<jc><f1>Message of the Day:\nWelcome to DeltaForce TRIBES!\n\nFire to spawn.";
...
$Server::respawnTime = 13; // number of seconds before a respawn is allowed
