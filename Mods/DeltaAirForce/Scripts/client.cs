...
function remoteMODInfo(%server, %modString)
{
   if(%server == 2048)
   {
      ...
      if($ServerModInfo != "")
      {
         Control::setValue(ModTextString, "<jc><f1>NOTICE: This server has been Accelerated to first class entertainment!\n<f0>" @ %modString);
      }
   }
}
...
function dataGotBlock(%blockName, %pctDone)
{
   if(%pctDone < 0.1)
      ...
      %text = "Die. Die. Die. Die. Die. Die...";
   else if(%pctDone < 0.7)
      %text = "Die. Die. Die. Die. Die. Die...";
   else if(%pctDone < 0.8)
      %text = "Die. Die. DIe. Die. Die. Die. Die...";
   else
      %text = "Die. Die. Die. Die. Die. Die. Die. Die...";
...
function dataFinished()
{
   ...
   Control::setValue(ProgressText, "<jc><f0>Hey look alive will you? The games about to start!");
