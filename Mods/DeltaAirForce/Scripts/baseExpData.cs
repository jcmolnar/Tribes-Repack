...
ExplosionData NewGrenExp
{
   shapeName = "tumult_large.dts";
   soundId   = GrenExplosion;
...
ExplosionData flashExpSuperSmall
{
   shapeName = "flash_small.dts";
   soundId   = debrisSmallExplosion;
