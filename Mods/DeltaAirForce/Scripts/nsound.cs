...
SoundProfileData Profile3dMedium2
{
   baseVolume = 0;
   minDistance = 70.0;
   maxDistance = 1000.0;
...
SoundProfileData Profile3dGren
{
   baseVolume = 0;
   minDistance = 5.0;
   maxDistance = 250.0;
...
SoundData SoundDiscSpin
{
   ...
   profile = Profile3dMediumLoop2; 
   //profile = Profile3dMediumLoop; //make the sounds go further
};
...
SoundData GrenExplosion
{
   wavFileName = "debris_medium.wav";
   profile     = Profile3dGren;
};
...
SoundData thunderExplosion
{
   wavFileName = "shockexp.wav";
   profile     = Thunder3dFar;
};
...
SoundData SoundFlyerIdle
{
   ...
   //profile = Profile3dMediumLoop; 
   profile = Profile3dMediumLoop2; //Make the sounds go further
