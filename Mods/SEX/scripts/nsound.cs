...
SoundData SoundFlakDet
{
   wavFileName = "Pku_hlth.wav";//Pku_ammo.wav//plasma2.wav
   profile = Profile3dNear;
};

SoundData turretfire4
{
   wavFileName = "turretfire4.wav";
   profile = Profile3dNear;
};
SoundData energypackon
{
   wavFileName = "energypackon.wav";
   profile = Profile3dNear;
};
SoundData lightningidle
{
