...
{	  
   ...
   Player::setItemCount(%clientId,RepairKit,10);
	Player::useItem(%pl,RockLauncher);
...
function Player::leaveMissionArea(%player)
{
   %cl = Player::getClient(%player);
	Client::sendMessage(%cl,1,"Where you think you're going?");
	%player.outArea=1;
