...
{
   shapeName = "plasmaex.dts";
   soundId   = SoundFlakDet;//explosion4;//
...
ExplosionData KickbackExp
{
   shapeName = "shockwave_large.dts";
};


ExplosionData GblasterExp
{	shapeName = "enex.dts";
	soundId = energyExplosion;
	faceCamera = true;
	randomSpin = true;
...
ExplosionData HuckExp
{
   shapeName = "chainspk.dts";//Chainspk for reduced lag
   soundId   = energyExplosion;
   faceCamera = true;
   randomSpin = true;
   hasLight   = true;
