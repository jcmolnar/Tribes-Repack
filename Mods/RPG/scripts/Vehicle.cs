		...
		if (getObjectType (%object) == "Player" && %object.vehicle == "" && (getSimTime() > %object.newMountTime || %object.lastMount != %this) && %this.fading == "")
            ...
            if( Player::isAiControlled(%object) )
		      ...
		      %client = Player::getClient(%object);
				if ((%armor == "MagicMooCowArmor22" || %armor == "MaleHumanArmor0" || %armor == "FemaleHumanArmor0" || %armor == "MaleHumanArmor1" || %armor == "FemaleHumanArmor1" || %armor == "MaleHumanArmor2" || %armor == "FemaleHumanArmor2" || %armor == "MaleHumanArmor3" || %armor == "FemaleHumanArmor3" || %armor == "MaleHumanArmor4" || %armor == "FemaleHumanArmor4" || %armor == "MaleHumanArmor5" || %armor == "FemaleHumanArmor5" || %armor == "MaleHumanArmor6" || %armor == "FemaleHumanArmor6" || %armor == "MaleHumanArmor7" || %armor == "FemaleHumanArmor7" || %armor == "MaleHumanArmor8" || %armor == "FemaleHumanArmor8" || %armor == "MaleHumanArmor9" || %armor == "FemaleHumanArmor9" || %armor == "MaleHumanArmor10" || %armor == "FemaleHumanArmor10") && Vehicle::canMount (%this, %object))
					{
					...
					Client::sendMessage(Player::getClient(%object),0,"You cannot wear a robe and pilot the vehicles.~wError_Message.wav");
			}
	}
}
...
function Vehicle::passengerJump(%this,%passenger,%mom)
{
	...
	if(%armor == "MaleHumanArmor0" || %armor == "MaleHumanArmor0" || %armor == "MaleHumanArmor2" || %armor == "MaleHumanArmor3" || %armor == "MaleHumanArmor4" || %armor == "MaleHumanArmor5" || %armor == "MaleHumanArmor6" || %armor == "MaleHumanArmor7" || %armor == "MaleHumanArmor8" || %armor == "MaleHumanArmor9" || %armor == "MaleHumanArmor10") {
		%height = 2;
		%velocity = 70;
		%zVec = 70;
	}
	else if(%armor == "FemaleHumanArmor0" || %armor == "FemaleHumanArmor1" || %armor == "FemaleHumanArmor2" || %armor == "FemaleHumanArmor3" || %armor == "FemaleHumanArmor4" || %armor == "FemaleHumanArmor5" || %armor == "FemaleHumanArmor6" || %armor == "FemaleHumanArmor7" || %armor == "FemaleHumanArmor8" || %armor == "FemaleHumanArmor9" || %armor == "FemaleHumanArmor10") {
		%height = 2;
		%velocity = 100;
		%zVec = 100;
	}
