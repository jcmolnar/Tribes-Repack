...
function OptionsVideo::init()
{
   ...
   FGCombo::setSelected(IDCTG_OPTS_VID_RES, FGCombo::findEntry(IDCTG_OPTS_VID_RES, $pref::VideoFullScreenRes));
	...
	FGCombo::addEntry(OptionsVideo::OpenGLCombo, "TNT OpenGL", 0);
	FGCombo::addEntry(OptionsVideo::OpenGLCombo, "I740 OpenGL", 1);
	if ($pref::VideoOpenGLMode == "TNT")
	{
