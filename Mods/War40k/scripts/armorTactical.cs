//TACTICAL MARINE
// By Edgecrusher
$InvList[iarmorTactical] = 1;
$RemoteInvList[iarmorTactical] = 1;
$ArmorType[Male, iarmorTactical] = armormTactical;
$ArmorType[Female, iarmorTactical] = armorfTactical;
$ArmorName[armormTactical] = iarmorTactical;
$ArmorName[armorfTactical] = iarmorTactical;

ItemData iarmorTactical
{
	heading = $InvHead[ihMar];
	description = "Tactical Marine";
	className = "Armor";
	price = 15;
};

PlayerData armormTactical
{
	className = "Armor";
	shapeFile = "marine";
...
function armormTactical::onPlayerContact(%targetPlayer, %sourcePlayer)
{
	Armor::onPlayerContact(%targetPlayer, %sourcePlayer);
}

function armormTactical::onGrenade(%player)
{
	%obj = newObject("","Mine","Handgrenade");
	Armor::ThrowGrenade(%player, %obj);
}

function armormTactical::onBeacon(%player, %item)
{
...
function armormTactical::onRepairKit(%player)
{
	Armor::onRepairKit(%player);
}

function armormTactical::onMine(%player)
{
...
function armorfTactical::onPlayerContact(%targetPlayer, %sourcePlayer)
{
	Armor::onPlayerContact(%targetPlayer, %sourcePlayer);
}

function armorfTactical::onGrenade(%player)
{
	%obj = newObject("","Mine","Handgrenade");
	Armor::ThrowGrenade(%player, %obj);
}

function armorfTactical::onBeacon(%player, %item)
{
	if(%player.throwTime < getSimTime() )
	{
		%obj = newObject("","Mine","KrakGren");
...
function armorfTactical::onRepairKit(%player)
{
	Armor::onRepairKit(%player);
}

function armorfTactical::onMine(%player)
{
	Client::sendMessage(Player::getClient(%player),1, "Heavy Mine deployed.");
	if(%player.throwTime < getSimTime() )
	{
