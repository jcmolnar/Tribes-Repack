//Dire Avenger
// by Edgecrusher
$InvList[iarmorDiAvg] = 1;
$RemoteInvList[iarmorDiAvg] = 1;
$ArmorType[Male, iarmorDiAvg] = armormDiAvg;
$ArmorType[Female, iarmorDiAvg] = armorfDiAvg;
$ArmorName[armormDiAvg] = iarmorDiAvg;
$ArmorName[armorfDiAvg] = iarmorDiAvg;

ItemData iarmorDiAvg
{
	heading = $InvHead[ihEld];
	description = "Dire Avenger";
	className = "Armor";
	price = 12;
};

PlayerData armormDiAvg
{
	className = "Armor";
	shapeFile = "marmor";
...
function armormDiAvg::onPlayerContact(%targetPlayer, %sourcePlayer)
{
	Armor::onPlayerContact(%targetPlayer, %sourcePlayer);
}

function armormDiAvg::onGrenade(%player)
{
	%obj = newObject("","Mine","Handgrenade");
	Armor::ThrowGrenade(%player, %obj);
}

function armormDiAvg::onBeacon(%player, %item)
{
}

function armormDiAvg::onRepairKit(%player)
{
	Armor::onRepairKit(%player);
}

function armormDiAvg::onMine(%player)
{
...
function armorfDiAvg::onPlayerContact(%targetPlayer, %sourcePlayer)
{
	Armor::onPlayerContact(%targetPlayer, %sourcePlayer);
}

function armorfDiAvg::onGrenade(%player)
{
	%obj = newObject("","Mine","Handgrenade");
	Armor::ThrowGrenade(%player, %obj);
}

function armorfDiAvg::onBeacon(%player, %item)
{
}

function armorfDiAvg::onRepairKit(%player)
{
	Armor::onRepairKit(%player);
}

function armorfDiAvg::onMine(%player)
{
	Client::sendMessage(Player::getClient(%player),1, "Heavy Mine deployed.");
	if(%player.throwTime < getSimTime() )
	{
