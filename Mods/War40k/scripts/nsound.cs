...
{
   wavFileName = "littleboom.wav";
   profile     = Profile3dNear;
};

SoundData debrisMediumExplosion
{
   wavFileName = "medboom.wav";
   profile     = Profile3dNear;
};

SoundData debrisLargeExplosion
{
   wavFileName = "bigboom.wav";
   profile     = Profile3dNear;
};
...
{
   wavFileName = "jetflight.wav";
   profile = Profile3dMediumLoop;
};

SoundData SoundFlyerIdle
{
   wavFileName = "powersupply.wav";
   profile = Profile3dMediumLoop;
};
...
//-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=--=-=-
//   NEW SOUNDS FOR WARHAMMER 40k: Revelation
//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=

SoundData SoundHeavyWalk
{
 	WavFileName = "termwalk.wav";
	profile = Profile3dNear;
};

SoundData SoundFlameFire
{
	wavFileName = "flamer.wav";
	profile = Profile3dMedium;
};

SoundData SoundEversorFire
{
	wavFileName = "eversorshot.wav";
	profile = profile3dNear;
};

SoundData SoundShotgunFire
{
	wavFileName = "shotgun.wav";
	profile = profile3dNear;
};

//SoundData SoundPlayerBurning
//{
//	wavFileName = "burningplayer.wav"; --->make this sound start on ignition
//	profile = profile3dMediumLoop;
//};

SoundData SoundFusionFire
{
	wavFileName = "fusion.wav";
	profile = profile3dNear;
};

SoundData SoundBolterFire
{
	wavFileName = "bolterfire.wav";
	profile = profile3dNear;
};

SoundData SoundSnipeRifle
{
	wavFileName = "sniperifle.wav";
	profile = profile3dNear;
};


SoundData SoundHeavyBolterFire
{
	wavFileName = "stormer.wav";
	profile = profile3dMedium;
};

SoundData SoundFireNeedler
{
	wavFileName = "needler.wav";
	profile = profile3dNear;
};

SoundData SoundAssaultSpinUp
{
	wavFileName = "assaultup.wav";
	profile = profile3dnear;
};

SoundData SoundAssaultSpinDown
{
	wavFileName = "assaultdown.wav";
	profile = profile3dNear;
};

SoundData SoundAssaultFire
{
	wavFileName = "assaultfiring.wav";
	profile = profile3dNearLoop;
};

SoundData SoundFireShuriken
{
	wavFileName = "shuriken.wav";
	profile = profile3dNear;
};

SoundData SoundFireLas
{
	wavFileName = "sniper3.wav";
	profile = profile3dNear;
};

SoundData SoundFirePlas
{
	wavFileName = "plasmashot.wav";
	profile = profile3dNear;
};

SoundData SoundFireCyclone
{
	wavFileName= "cycloneshot.wav";
	profile = profile3dNear;
};

SoundData SoundParticleFire
{
	wavFileName = "particle.wav";
	profile = profile3dNear;
};

SoundData SoundFireMelta
{
	wavFileName = "meltafire.wav";
	profile = profile3dNear;
};

SoundData SoundIsolanthFire
{
	wavFileName= "isolanthfire.wav";
	profile = profile3dNear;
};

SoundData SoundDeathspin
{
	wavFileName= "deathspin.wav";
	profile = profile3dNear;
};
