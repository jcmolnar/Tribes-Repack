//DEVASTATOR
// by Edgecrusher
$InvList[iarmorDevastator] = 1;
$RemoteInvList[iarmorDevastator] = 1;
$ArmorType[Male, iarmorDevastator] = armormDevastator;
$ArmorType[Female, iarmorDevastator] = armorfDevastator;
$ArmorName[armormDevastator] = iarmorDevastator;
$ArmorName[armorfDevastator] = iarmorDevastator;

ItemData iarmorDevastator
{
...
function armormDevastator::onPlayerContact(%targetPlayer, %sourcePlayer)
{
	Armor::onPlayerContact(%targetPlayer, %sourcePlayer);
}

function armormDevastator::onGrenade(%player)
{
	%obj = newObject("","Mine","Plasgren");
	Armor::ThrowGrenade(%player, %obj);
}

function armormDevastator::onBeacon(%player, %item)
{
	Client::sendMessage(Player::getClient(%player),1, "Firebomb will explode in 6 seconds.");
...
function armormDevastator::onRepairKit(%player)
{
	Armor::onRepairKit(%player);
}

PlayerData armorfDevastator
{
	className = "Armor";
	shapeFile = "mfemale";
	flameShapeName = "mflame";
...
function armorfDevastator::onPlayerContact(%targetPlayer, %sourcePlayer)
{
	Armor::onPlayerContact(%targetPlayer, %sourcePlayer);
}

function armorfDevastator::onGrenade(%player)
{
	%obj = newObject("","Mine","Plasgren");
	Armor::ThrowGrenade(%player, %obj);
}

function armorfDevastator::onBeacon(%player, %item)
{
...
function armorfDevastator::onRepairKit(%player)
{
	Armor::onRepairKit(%player);
}