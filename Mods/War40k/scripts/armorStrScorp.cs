//Striking Scorpion
// by Edgecrusher
$InvList[iarmorStrScorp] = 1;
$RemoteInvList[iarmorStrScorp] = 1;
$ArmorType[Male, iarmorStrScorp] = armormStrScorp;
$ArmorType[Female, iarmorStrScorp] = armorfStrScorp;
$ArmorName[armormStrScorp] = iarmorStrScorp;
$ArmorName[armorfStrScorp] = iarmorStrScorp;



ItemData iarmorStrScorp
{
	heading = $InvHead[ihEld];
	description = "Striking Scorpion";
	className = "Armor";
	price = 16;
};

PlayerData armormStrScorp
{
	className = "Armor";
	shapeFile = "larmor";
...
function armormStrScorp::onPlayerContact(%targetPlayer, %sourcePlayer)
{
	Armor::onPlayerContact(%targetPlayer, %sourcePlayer);
}

function armormStrScorp::onGrenade(%player)
{
	%obj = newObject("","Mine","Krakgren");
	Armor::ThrowGrenade(%player, %obj);
}

function armormStrScorp::onBeacon(%player, %item)
{
	Armor::SpeedBooster(%player, %item, 400);
}

function armormStrScorp::onRepairKit(%player)
{
	Armor::onRepairKit(%player);
}

PlayerData armorfStrScorp
{
	className = "Armor";
	shapeFile = "lfemale";
	flameShapeName = "lflame";
...
function armorfStrScorp::onPlayerContact(%targetPlayer, %sourcePlayer)
{
	Armor::onPlayerContact(%targetPlayer, %sourcePlayer);
}

function armorfStrScorp::onGrenade(%player)
{
	%obj = newObject("","Mine","Krakgren");
	Armor::ThrowGrenade(%player, %obj);
}

function armorfStrScorp::onBeacon(%player, %item)
{
	Armor::SpeedBooster(%player, %item, 400);
}

function armorfStrScorp::onRepairKit(%player)
{
	Armor::onRepairKit(%player);
}