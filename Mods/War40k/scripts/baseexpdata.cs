ExplosionData reaperExp
{
	...
	timeZero = 0.250;
	timeOne = 0.850;
	colors[0] = { 0.4, 0.4,0.0 };
	colors[1] = { 0.0, 0.0,0.2 };
	colors[2] = { 1.0, 0.5, 1.0 };
...
ExplosionData DCannonBoom
{
	...
	colors[1] = { 3.0, 4.0, 5.0 };
	colors[2] = { 2.0, 2.0, 3.0 };
	radFactors = { 1.0, 1.5, 2.0 };
};

SoundData SoundSpray
{
	wavFileName = "zapdeath.wav";
	profile = Profile3dNear;
};

ExplosionData PlasCannon
{
	shapeName = "plasmaex.dts";
	soundId = shockExplosion;
	faceCamera = true;
...
ExplosionData flashGrenExp4
{
	shapeName = "fiery.dts"; //grenade
	soundId = bigExplosion3;
	faceCamera = true;
	randomSpin = true;
	hasLight = true;
...
ExplosionData isoExp
{
	...
	colors[2] = { 0.0, 0.5, 0.5 };
	radFactors = { 0.5, 0.5, 0.3 };
};

ExplosionData PlasAutoExp
{
	shapeName = "plasmaex.dts";
	soundId = explosion4;
	faceCamera = true;
