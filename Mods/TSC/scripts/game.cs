...
//---------------------------------------------------------------------------------
$deathMsg[$LandingDamageType, 0]      = "%2 dies";
$deathMsg[$LandingDamageType, 1]      = "%2 dies";
$deathMsg[$LandingDamageType, 2]      = "%2 dies";
$deathMsg[$LandingDamageType, 3]      = "%2 dies";
$deathMsg[$ImpactDamageType, 0]      = "%1 [Hit and Run] %2";
$deathMsg[$ImpactDamageType, 1]      = "%1 [Hit and Run] %2";
$deathMsg[$ImpactDamageType, 2]      = "%1 [Hit and Run] %2";
$deathMsg[$ImpactDamageType, 3]      = "%1 [Hit and Run] %2";
$deathMsg[$BulletDamageType, 0]      = "%1 [FireHawk 12mm] %2";
$deathMsg[$BulletDamageType, 1]      = "%1 [FireHawk 12mm] %2";
$deathMsg[$BulletDamageType, 2]      = "%1 [FireHawk 12mm] %2";
$deathMsg[$BulletDamageType, 3]      = "%1 [FireHawk 12mm] %2";
...
$deathMsg[$PlasmaDamageType, 0]      = "%1 [AR-20] %2";
$deathMsg[$PlasmaDamageType, 1]      = "%1 [AR-20] %2";
$deathMsg[$PlasmaDamageType, 2]      = "%1 [AR-20] %2";
$deathMsg[$PlasmaDamageType, 3]      = "%1 [AR-20] %2";
...
$deathMsg[$ShrapnelDamageType, 0]    = "%1 [Shrapnel] %2";
$deathMsg[$ShrapnelDamageType, 1]    = "%1 [Shrapnel] %2";
$deathMsg[$ShrapnelDamageType, 2]    = "%1 [Shrapnel] %2";
$deathMsg[$ShrapnelDamageType, 3]    = "%1 [Shrapnel] %2";
$deathMsg[$LaserDamageType, 0]       = "%1 [THX-2] %2";
$deathMsg[$LaserDamageType, 1]       = "%1 [THX-2] %2";
$deathMsg[$LaserDamageType, 2]       = "%1 [THX-2] %2";
$deathMsg[$LaserDamageType, 3]       = "%1 [THX-2] %2";
$deathMsg[$MortarDamageType, 0]      = "%1 [MM-80C] %2";
$deathMsg[$MortarDamageType, 1]      = "%1 [MM-80C] %2";
$deathMsg[$MortarDamageType, 2]      = "%1 [MM-80C] %2";
$deathMsg[$MortarDamageType, 3]      = "%1 [MM-80C] %2";
...
$deathMsg[$CrushDamageType, 0]		 = "[Crushed] %2";
$deathMsg[$CrushDamageType, 1]		 = "[Crushed] %2";
$deathMsg[$CrushDamageType, 2]		 = "[Crushed] %2";
$deathMsg[$CrushDamageType, 3]		 = "[Crushed] %2";
$deathMsg[$DebrisDamageType, 0]		 = "%1 [Shrapnel] %2";
$deathMsg[$DebrisDamageType, 1]		 = "%1 [Shrapnel] %2";
$deathMsg[$DebrisDamageType, 2]		 = "%1 [Shrapnel] %2";
$deathMsg[$DebrisDamageType, 3]		 = "%1 [Shrapnel] %2";
$deathMsg[$MissileDamageType, 0]	    = "%1 [Missile] %2";
$deathMsg[$MissileDamageType, 1]	    = "%1 [Missile] %2";
$deathMsg[$MissileDamageType, 2]	    = "%1 [Missile] %2";
$deathMsg[$MissileDamageType, 3]	    = "%1 [Missile] %2";
$deathMsg[$MineDamageType, 0]	       = "%1 [Land Mine] %2";
$deathMsg[$MineDamageType, 1]	       = "%1 [Land Mine] %2";
$deathMsg[$MineDamageType, 2]	       = "%1 [Land Mine] %2";
$deathMsg[$MineDamageType, 3]	       = "%1 [Land Mine] %2";

// "you just killed yourself" messages
//   %1 = player name,  %2 = player gender pronoun

$deathMsg[-2,0]						 = "[Suicide] %1";
$deathMsg[-2,1]						 = "[Suicide] %1";
$deathMsg[-2,2]						 = "[Suicide] %1";
$deathMsg[-2,3]						 = "[Suicide] %1";
...
{
   messageAll(0, "All units are go in " @ %time @ " seconds.");
...
function Game::startMatch()
{
   ...
   messageAll(0, "Insertion Complete. All units engage.");
	Game::resetScores();	
