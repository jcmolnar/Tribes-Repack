...
//$TeamForRace[BattleDroid] = 0;

$RaceToArmorType[DeathKnight] = DeathKnightArmor22;
//$RaceToArmorType[BattleDroid] = DeathKnightArmor23;

$ArmorTypeToRace[DeathKnightArmor22] = DeathKnight;
//$ArmorTypeToRace[DeathKnightArmor23] = BattleDroid;

$ArmorForSpeed[0, DeathKnight] = DeathKnightArmor22;
$ArmorForSpeed[0, BattleDroid] = DeathKnightArmor23;
...
//------------------------------------------------------------------
// DeathKnightArmor23 data:
//------------------------------------------------------------------

PlayerData DeathKnightArmor23
{
   className = "Armor";
   shapeFile = "droid";
