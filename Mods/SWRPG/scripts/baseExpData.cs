...
//                red, grn, blu
   colors[0]  = { 2.0, 0.0, 0.0 };
   colors[1]  = { 2.0, 0.0, 0.0 };
   colors[2]  = { 2.0, 0.0, 0.0 };
   radFactors = { 1.0, 1.0, 1.0 };
 };

ExplosionData grnblast
{
   shapeName = "tumult_small.dts";
   soundId   = debrisSmallExplosion;
   ...
   colors[0]  = { 0.0, 2.0, 0.0 };
   colors[1]  = { 0.0, 2.0, 0.0 };
   colors[2]  = { 0.0, 2.0, 0.0 };
   radFactors = { 1.0, 1.0, 1.0 };
};

ExplosionData blublast
{
   shapeName = "enex.dts";
   ...
   colors[0]  = { 0.25, 0.25, 1 };
   colors[1]  = { 0.25, 0.25, 1 };
   colors[2]  = { 1, 1,  1 };
   radFactors = { 1, 1,  1 };
};

ExplosionData rvblast
{
   shapeName = "tumult_small.dts";
   soundId   = debrisSmallExplosion;
