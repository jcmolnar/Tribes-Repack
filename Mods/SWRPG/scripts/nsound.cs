...
SoundData SoundFireSaber
{
   wavFileName = "saberswing.wav";
   profile = Profile3dNear;
};

SoundData SoundPickUpSaber
{
   wavFileName = "saberrdy.wav";
   profile = Profile3dNear;
};

SoundData SoundSaberIdle
{
   wavFileName = "saberidle.wav";
   profile = Profile3dNearLoop;
};

SoundData SoundSaberHit
{
   wavFileName = "saberhit.wav";
   profile = Profile3dNear;
};
...
SoundData SoundFireBlaster2
{
   wavFileName = "desertrifle.wav";
   profile = Profile3dNear;
};

SoundData SoundFireRepeater
{
   wavFileName = "MachineGun.wav";
   profile = Profile3dNearLoop;
};
...
{
   wavFileName = "Machinegun3.wav";
   profile = Profile3dNear;
};

SoundData SoundSpinDown
{
   wavFileName = "Machinegun2.wav";
   profile = Profile3dNear;
};
...
SoundData SoundFlyerIdle2
{
   wavFileName = "float_target.wav";
   profile = Profile3dMediumLoop;
};

SoundData SoundFlyerFireLaser
{
	wavFileName = "lasercannon.WAV";
	profile = Profile3dMedium;
};
...
//---- SWRPG's added sounds.

SoundData SoundCough1
{
   wavFileName = "cough1.wav";
   profile = Profile3dNear;
};

SoundData SoundCough2
{
   wavFileName = "cough2.wav";
   profile = Profile3dNear;
};

SoundData SoundCough3
{
   wavFileName = "cough3.wav";
   profile = Profile3dNear;
};

SoundData SoundCough4
{
   wavFileName = "cough4.wav";
   profile = Profile3dNear;
};
