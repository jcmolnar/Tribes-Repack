...
$DamageScale[LAPC, $PlasmaDamageType] = 1.5;
...
$DamageScale[LAPC, $MissileDamageType] = 1.5;
...
$DamageScale[LAPC, $AWingDamageType]           = 1.0;
$DamageScale[LAPC, $XWingDamageType]           = 1.0;
$DamageScale[LAPC, $SNOWSPEEDERDamageType]     = 1.0;
$DamageScale[LAPC, $TIEDamageType]             = 1.0;
$DamageScale[LAPC, $TIEINTERCEPTORDamageType]  = 1.0;
$DamageScale[LAPC, $TIEBOMBDamageType]         = 1.0;
$DamageScale[LAPC, $AWingDamageType]           = 1.0;
$DamageScale[LAPC, $MSaberDamageType] 	      = 50.0;
$DamageScale[LAPC, $BSaberDamageType] 	      = 50.0;
$DamageScale[LAPC, $GSaberDamageType] 	     = 50.0;
$DamageScale[LAPC, $RSaberDamageType] 	      = 50.0;

$DamageScale[HAPC, $ImpactDamageType] = 1.0;
$DamageScale[HAPC, $EMPDamageType] = 1.0;
$DamageScale[HAPC, $BulletDamageType] = 1.0;
$DamageScale[HAPC, $PlasmaDamageType] = 1.5;
...
$DamageScale[HAPC, $MissileDamageType] = 1.5;
...
$DamageScale[HAPC, $AWingDamageType]           = 1.0;
$DamageScale[HAPC, $XWingDamageType]           = 1.0;
$DamageScale[HAPC, $SNOWSPEEDERDamageType]     = 1.0;
$DamageScale[HAPC, $TIEDamageType]             = 1.0;
$DamageScale[HAPC, $TIEINTERCEPTORDamageType]  = 1.0;
$DamageScale[HAPC, $TIEBOMBDamageType]         = 1.0;
$DamageScale[HAPC, $AWingDamageType]           = 1.0;
$DamageScale[HAPC, $MSaberDamageType] 	      = 50.0;
$DamageScale[HAPC, $BSaberDamageType] 	      = 50.0;
$DamageScale[HAPC, $GSaberDamageType] 	     = 50.0;
$DamageScale[HAPC, $RSaberDamageType] 	      = 50.0;
...
if (%armor == "hsarmor" || %armor == "luarmor" || %armor == "dtarmor" || %armor == "larmor" || %armor == "harmor" || %armor == "marmor" || %armor == "sluarmor" ||%armor == "drarmor" || %armor == "dvarmor" || %armor == "xarmor" || %armor == "plarmor" || %armor == "rparmor" )
	{
		%height = 2;
		%velocity = 70;
		%zVec = 70;
