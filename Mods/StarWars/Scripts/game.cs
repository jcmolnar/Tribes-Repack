...
$deathMsg[$BulletDamageType, 0]      = "%1's Repeater tears %2 to shread.";
$deathMsg[$BulletDamageType, 1]      = "%1's turned %2 into a steaming pile of mush.";
$deathMsg[$BulletDamageType, 2]      = "%1's Repeater tears %2 to shread.";
$deathMsg[$BulletDamageType, 3]      = "%1's turned %2 into a steaming pile of mush.";
...
$deathMsg[$MortarDamageType, 0]      = "%1 Snipes %2 in the head.";
$deathMsg[$MortarDamageType, 1]      = "The Last Thing %2 seen was the glare off of %1's Desert Rifle.";
$deathMsg[$MortarDamageType, 2]      = "%1 sprays blood all over %2's nice new shirt.";
$deathMsg[$MortarDamageType, 3]      = "%1 pops %2 like a pringles can.";
...
$deathMsg[$ElectricityDamageType, 0] = "%2 felt the true power of the force frorm Darth %1.";
$deathMsg[$ElectricityDamageType, 1] = "Darth %1 showed %2 the true power of the force.";
$deathMsg[$ElectricityDamageType, 2] = "%2 gets his monkey spanked by Darth %1.";
$deathMsg[$ElectricityDamageType, 3] = "Darth %1 showed %2 the ropes.";
...
// STARWARS DEATH MESSAGES
// ==Vehicles==============================================================================================================================
// ========================================================================================================================================
$deathMsg[$AWINGDamageType, 0]     = "%2 gets a shot down by %1's A-Wing.";
$deathMsg[$AWINGDamageType, 1]     = "%2 takes %1's laser in the chest from his A-Wing.";
$deathMsg[$AWINGDamageType, 2]     = "%1's chased %2 down with his A-Wing lasers.";
$deathMsg[$AWINGDamageType, 3]     = "%2 counld not outrun %1's A-Wing lasers.";
// ========================================================================================================================================
$deathMsg[$SNOWSPEEDERDamageType, 0]     = "%2 gets a shot down by %1's SnowSpeeder.";
$deathMsg[$SNOWSPEEDERDamageType, 1]     = "%2 takes %1's laser in the chest from his SnowSpeeder.";
$deathMsg[$SNOWSPEEDERDamageType, 2]     = "%1's chased %2 down with his SnowSpeeder lasers.";
$deathMsg[$SNOWSPEEDERDamageType, 3]     = "%2 counld not outrun %1's SnowSpeeder lasers.";
// ========================================================================================================================================
$deathMsg[$TIEDamageType, 0]     = "%2 gets a shot down by %1's TIE.";
$deathMsg[$TIEDamageType, 1]     = "%2 takes %1's laser in the chest from his TIE.";
$deathMsg[$TIEDamageType, 2]     = "%1's chased %2 down with his TIE lasers.";
$deathMsg[$TIEDamageType, 3]     = "%2 counld not outrun %1's TIE lasers.";
// ========================================================================================================================================
$deathMsg[$TIEINTERCEPTORDamageType, 0]     = "%2 gets a shot down by %1's TIE Interceptor.";
$deathMsg[$TIEINTERCEPTORDamageType, 1]     = "%2 takes %1's laser in the chest from his TIE Interceptor.";
$deathMsg[$TIEINTERCEPTORDamageType, 2]     = "%1's chased %2 down with his TIE Interceptor lasers.";
$deathMsg[$TIEINTERCEPTORDamageType, 3]     = "%2 counld not outrun %1's TIE Interceptor lasers.";
// ========================================================================================================================================
$deathMsg[$TIEBOMBDamageType, 0]     = "%1's TIE Bomber locked onto %2's head.";
$deathMsg[$TIEBOMBDamageType, 1]     = "%2 didn't see notice the blue spheres %1 dropped from %3 TIE Bomber.";
$deathMsg[$TIEBOMBDamageType, 2]     = "%1's TIE Bomber inflicts a shrapnel wound on %2 .";
$deathMsg[$TIEBOMBDamageType, 3]     = "%1's TIE Bomber takes out %2.";
// ========================================================================================================================================
$deathMsg[$YWINGDamageType, 0]     = "%1's Y-Wing locked onto %2's head.";
$deathMsg[$YWINGDamageType, 1]     = "%2 didn't see notice the blue spheres %1 dropped from %3 Y-Wing.";
$deathMsg[$YWINGDamageType, 2]     = "%1's Y-Wing inflicts a shrapnel wound on %2 .";
$deathMsg[$YWINGDamageType, 3]     = "%1's Y-Wing takes out %2.";
// ========================================================================================================================================
// ==Weapons===SABERS======================================================================================================================
$deathMsg[$MSaberDamageType, 0]     = "%2 bow's down to Darth %1's Light Saber.";
$deathMsg[$MSaberDamageType, 1]     = "Darth %1 cuts %2 into a pile of mush with %3 Double Saber.";
$deathMsg[$MSaberDamageType, 2]     = "%2 feels the True power of the dark side from Darth %1's Light Saber.";
$deathMsg[$MSaberDamageType, 3]     = "Darth %1 cuts %2 to bits with %3 Light Saber.";
// ========================================================================================================================================
$deathMsg[$BSaberDamageType, 0]     = "%2 gets cut down by %1's Blue Light Saber.";
$deathMsg[$BSaberDamageType, 1]     = "%2 was sliced into a steamy pile of mush by %1's Blue Light Saber.";
$deathMsg[$BSaberDamageType, 2]     = "%1's Blue Light Saber shows %2 a new world of pain.";
$deathMsg[$BSaberDamageType, 3]     = "%2 bow's down to %1's Blue Light Saber.";
// ========================================================================================================================================
$deathMsg[$GSaberDamageType, 0]     = "%2 gets cut down by %1's Green Light Saber.";
$deathMsg[$GSaberDamageType, 1]     = "%2 was sliced into a steamy pile of mush by %1's Green Light Saber.";
$deathMsg[$GSaberDamageType, 2]     = "%1's Green Light Saber shows %2 a new world of pain.";
$deathMsg[$GSaberDamageType, 3]     = "%2 bow's down to %1's Green Light Saber.";
// ========================================================================================================================================
$deathMsg[$RSaberDamageType, 0]     = "%2 gets cut down by %1's Red Light Saber.";
$deathMsg[$RSaberDamageType, 1]     = "%2 feels the True power of the dark side from %1's Red Light Saber.";
$deathMsg[$RSaberDamageType, 2]     = "%2 was sliced into a steamy pile of mush by %1's Red Light Saber.";
$deathMsg[$RSaberDamageType, 3]     = "%1's Red Light Saber shows %2 a new world of pain.";
// ========================================================================================================================================
// ========================================================================================================================================
// ========================================================================================================================================
// ========================================================================================================================================
...
//NEW//
//$spawnBuyList[0] = Blaster;
//$spawnBuyList[1] = LightArmor;
//$spawnBuyList[2] = "";
//$spawnBuyList[3] = RepairKit;
//$spawnBuyList[4] = "";
//$spawnBuyList[5] = "";

$spawnBuyList[rparmor,0] = NBlaster;
$spawnBuyList[rparmor,1] = RPilotArmor;
$spawnBuyList[rparmor,2] = "";
$spawnBuyList[rparmor,3] = RepairKit;
$spawnBuyList[rparmor,4] = Grenade;
$spawnBuyList[rparmor,5] = BlasterAmmo;
$spawnBuyList[rparmor,6] = "";

$spawnBuyList[larmor,0] = Blaster;
$spawnBuyList[larmor,1] = LightArmor;
$spawnBuyList[larmor,2] = "";
$spawnBuyList[larmor,3] = RepairKit;
$spawnBuyList[larmor,4] = Grenade;
$spawnBuyList[larmor,5] = BlasterAmmo;
$spawnBuyList[larmor,6] = "";

$spawnBuyList[marmor,0] = NBlaster;
$spawnBuyList[marmor,1] = MediumArmor;
$spawnBuyList[marmor,2] = "";
$spawnBuyList[marmor,3] = RepairKit;
$spawnBuyList[marmor,4] = Grenade;
$spawnBuyList[marmor,5] = BlasterAmmo;
$spawnBuyList[marmor,6] = "";

$spawnBuyList[harmor,0] = TBlaster;
$spawnBuyList[harmor,1] = HeavyArmor;
$spawnBuyList[harmor,2] = "";
$spawnBuyList[harmor,3] = RepairKit;
$spawnBuyList[harmor,4] = Grenade;
$spawnBuyList[harmor,5] = BlasterAmmo;
$spawnBuyList[harmor,6] = "";
//new//
...
//MORE WIERD STUFF//
//NEW//
	%team_armor[1]="rparmor";//REB
	%team_armor[2]="harmor";//IMP
	%team_armor[3]="";

	%armor=%team_armor[Client::getTeam(%clientId)+1];
	if(%armor=="")
	{
	      %armor = "rparmor";
	}
...
{						  
	%clientId.spawn= 1;
	%max = getNumItems();
   for(%i = 0; (%item = $spawnBuyList[%armor,%i]) != ""; %i++)
   {
