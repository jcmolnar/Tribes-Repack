...
MissionRegObject( Stations, "Computer Station", MissionCreateObject, ComputerStation, StaticShape, Computer1);
MissionRegObject( Stations, "Computer Unit", MissionCreateObject, ComputerUnit, StaticShape, Computer2);
...
MissionRegObject( Turrets, "Ion Turret",  MissionCreateObject, plasmaTurret, Turret, plasmaTurret );
...
MissionRegObject( Turrets, "Turbo Laser Battery",     MissionCreateObject, TurboLaserBattery,    Turret, TurboLaserBattery );
MissionRegObject( Turrets, "Atgar Laser Cannon",     MissionCreateObject, AtgarCannon,    Turret, AtgarCannon );
...
MissionRegItem( Weapons, "Blaster Rifle", BlasterRifle, 1);
MissionRegItem( Weapons, "Repeater", Repeater, 1);
MissionRegItem( Weapons, "Desert Rifle", GrenadeLauncher, 1);

//
//
//

MissionRegItem( Ammo, "Desert Rifle Ammo", DesertRifleAmmo, 10);
MissionRegItem( Ammo, "Blaster Ammo", BlasterAmmo, 25);
MissionRegItem( Ammo, "Repeater Ammo", RepeaterAmmo, 50);
...
MissionRegObject( Base, "SW Cargo Crate", MissionCreateObject, MagCargo, StaticShape, CargoCrate );
...
MissionRegObject( Misc, "ForceField 3x4", MissionCreateObject, Forcefield3x4, StaticShape, ForceField2 );
MissionRegObject( Misc, "Forcefield 4x14", MissionCreateObject, Forcefield4x14, StaticShape, ForceField3 );
MissionRegObject( Misc, "Forcefield 4x17", MissionCreateObject, Forcefield4x17, StaticShape, ForceField4 );
MissionRegObject( Misc, "Forcefield 4x8", MissionCreateObject, Forcefield4x18, StaticShape, ForceField5 );
MissionRegObject( Misc, "Forcefield 5x5", MissionCreateObject, Forcefield5x5, StaticShape, ForceField6 );
MissionRegObject(Misc, "Energy Pad", MissionCreateObject, EnergyPad, StaticShape, energypad);
MissionRegObject(Misc, "Main Pad", MissionCreateObject, MainPad, StaticShape, mainpad);
MissionRegObject(Misc, "Spawn Arrow", MissionCreateObject, SpawnArrow, StaticShape, pointingarrow);
MissionRegObject(Misc, "Gun Turret", MissionCreateObject, GunTurret, StaticShape, gunturret);
MissionRegObject(Misc, "Satalite Big", MissionCreateObject, SatBig, StaticShape, satbig);
MissionRegObject(Misc, "Solar Small", MissionCreateObject, SmallSolar, StaticShape, solarsmall);
//
//
//
