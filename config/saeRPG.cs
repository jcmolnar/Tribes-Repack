// saeRPG.cs -- default keybind set for the Options > Controls "RPG (Kronos) Defaults" button.
//
// GENERATED COPY. Source: RPG\scripts\sae.cs
...
bindCommand(keyboard, make, f, to, "nextWeapon();");
