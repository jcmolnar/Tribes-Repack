...
//
//   Launch via "Host RMRPG Server.bat" (NativeTribes.exe -mod rmrpg -dedicated).
//   This override applies regardless of which exe hosts.
// ---------------------------------------------------------------------------
...
$AdminPassword[3] = "";
$AdminPassword[4] = "";
$AdminPassword[5] = "changeme";  // CHANGE THIS before hosting publicly. In-game: SAD("changeme");
