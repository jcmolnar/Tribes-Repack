...
bindAction(keyboard0, make, "j", TO, IDACTION_MENU_PAGE, 2);
bindCommand(keyboard0, make, l_shift, "s", TO, "StatHUD::Show();");
bindCommand(keyboard0, break, l_shift, "s", TO, "StatHUD::Hide();");
bindCommand(keyboard0, make, "p", TO, "remoteEval(2048, ToggleCommandMode);");
...
bindCommand(keyboard0, make, "n", TO, "$throwStartTime=0; throwRelease(\"Mine\");");
bindCommand(keyboard0, make, "g", TO, "$throwStartTime=0; throwRelease(\"Grenade\");");
bindCommand(keyboard0, make, "f", TO, "throwStart(); throwRelease(\"Grenade\");");
bindCommand(keyboard0, make, "lshift", TO, "use(\"BackPack\");");
bindCommand(keyboard0, make, "lcontrol", TO, "drop(Flag);");
bindCommand(keyboard0, make, "k", TO, "kill();");
bindCommand(keyboard0, make, "c", TO, "TV::Activate($TV::Carrier);");
bindCommand(keyboard0, break, "c", TO, "TV::DeActivate();");
bindCommand(keyboard0, make, "m", TO, "drop(BackPack);");
bindCommand(keyboard0, make, "lalt", TO, "drop(Weapon);");
bindAction(mouse0, xaxis0, TO, IDACTION_YAW, Flip, Scale, 0.0002);
bindAction(mouse0, yaxis0, TO, IDACTION_PITCH, Flip, Scale, 0.0002);
