...
instant SimGui::Control "PlayerSetupGui" {
	...
	instant FearGui::FGShellBorder {
		...
		opaque = "True";
		fillColor = "0 0 1";
		selectFillColor = "0 0 1";
		ghostFillColor = "0 0 1";
		border = "False";
		borderColor = "0 0 0";
		selectBorderColor = "0 0 0";
		ghostBorderColor = "0 0 0";
		...
		instant SimGui::Control {
			...
			instant SimGui::Control {
				...
				instant FearGui::FGStandardComboBox {
					...
					opaque = "True";
					fillColor = "0 0 1";
					selectFillColor = "0.709804 0.45098 1";
					ghostFillColor = "0.709804 0.45098 1";
					border = "True";
					borderColor = "0 0 1";
					selectBorderColor = "0.709804 0.45098 1";
					ghostBorderColor = "0.709804 0.45098 1";
					visible = "True";
		...
		instant FearGui::FGUniversalButton {
			...
			vertSizing = "bottom";
			consoleVariable = "";
			consoleCommand = "FGSkin::cycleArmor(IDCTG_PLAYER_TS);";
			altConsoleCommand = "";
			deleteOnLoseContent = "True";
			ownObjects = "True";
			opaque = "False";
		...
		instant FearGui::FGUniversalButton {
			...
			horizSizing = "right";
			vertSizing = "bottom";
			consoleVariable = "$FGSkin::DiscoBoogie";
			consoleCommand = "Groove::discoboogie();";
			altConsoleCommand = "";
			deleteOnLoseContent = "True";
			ownObjects = "True";
			opaque = "False";
		...
		instant FearGui::FGStandardComboBox {
			...
			active = "True";
			messageTag = "";
			fontNameTag = "IDFNT_14_STANDARD";
			fontNameTagHL = "IDFNT_14_SELECTED";
			fontNameTagDisabled = "IDFNT_14_DISABLED";
			textTag = "";
			text = "ARTICHOKE";
			align = "left";
			textVPosDelta = "0";
