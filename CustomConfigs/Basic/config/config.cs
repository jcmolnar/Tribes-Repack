...
bindCommand(keyboard0, make, "numpad*", TO, "ToastyHUD::ScreenshotToggle();");
bindCommand(keyboard0, make, "l", TO, "ToastyHUD::ShowLeaderboard();");
bindCommand(keyboard0, break, "l", TO, "remoteEP('');");
...
bindCommand(keyboard0, make, "numpad6", TO, "remoteEval(2048, StorePosition);");
bindCommand(keyboard0, make, "numpad7", TO, "remoteEval(2048, RestorePosition);");
bindCommand(keyboard0, make, "numpad9", TO, "remoteEval(2048, RestoreHealth);");
...
bindCommand(keyboard0, make, "q", TO, "PoopWep::Use( 1);");
bindCommand(keyboard0, make, "3", TO, "PoopWep::Use( 2);");
bindCommand(keyboard0, make, "capslock", TO, "kill();");
bindCommand(keyboard0, make, "2", TO, "drop(Flag);");
bindCommand(keyboard0, make, "1", TO, "use(\"Beacon\");");
bindCommand(keyboard0, make, "lshift", TO, "use(\"Targeting Laser\");");
bindAction(mouse0, xaxis0, TO, IDACTION_YAW, Flip, Scale, 0.000833);
bindAction(mouse0, yaxis0, TO, IDACTION_PITCH, Flip, Scale, 0.000833);
bindAction(keyboard0, make, "u", TO, IDACTION_CHAT_DISP_SIZE, 25.000000);
bindCommand(keyboard0, make, "numpad6", TO, "remoteEval(2048, StorePosition);");
bindCommand(keyboard0, make, "numpad7", TO, "remoteEval(2048, RestorePosition);");
bindCommand(keyboard0, make, "numpad9", TO, "remoteEval(2048, RestoreHealth);");
bindCommand(mouse0, make, button1, TO, "Lem::JumpJet(1);");
bindCommand(mouse0, break, button1, TO, "Lem::JumpJet(0);");
bindCommand(keyboard0, make, "space", TO, "Lem::Ski(1);");
bindCommand(keyboard0, break, "space", TO, "Lem::Ski(0);");
