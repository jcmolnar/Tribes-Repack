...
bindCommand(keyboard0, make, "4", TO, "remoteEval(2048, ToggleCommandMode);");
...
bindCommand(keyboard0, make, "x", TO, "say(1, \"l\x03\x03\x03\x03\x03\x03l GET THE FLAG l\x03\x03\x03\x03\x03\x03l~wgeteflg\");");
bindCommand(keyboard0, make, "lshift", TO, "say(1, \"l\x03\x03\x03\x03\x03\x03l RETURN THE FLAG l\x03\x03\x03\x03\x03\x03l~wretflag\");");
...
bindCommand(keyboard0, make, "right", TO, "say(1, \"l\x03\x03\x03\x03\x03\x03l EAST l\x03\x03\x03\x03\x03\x03l~wincom2\");");
bindCommand(keyboard0, make, "left", TO, "say(1, \"l\x03\x03\x03\x03\x03\x03l WEST l\x03\x03\x03\x03\x03\x03l~wincom2\");");
...
bindAction(keyboard0, make, l_shift, "i", TO, IDACTION_CHAT_DISP_SIZE, -1);
bindCommand(keyboard0, make, "f2", TO, "AutoBuy::SelectAndBuyLoadout(1);");
bindCommand(keyboard0, make, "f3", TO, "AutoBuy::SelectAndBuyLoadout(2);");
bindCommand(keyboard0, make, "f4", TO, "AutoBuy::SelectAndBuyLoadout(3);");
bindCommand(keyboard0, make, "f5", TO, "AutoBuy::SelectAndBuyLoadout(4);");
bindCommand(keyboard0, make, "f6", TO, "AutoBuy::SelectAndBuyLoadout(5);");
...
bindCommand(keyboard0, make, "f", TO, "$throwStartTime=0; throwRelease(\"Grenade\");");
...
bindCommand(keyboard0, make, "r", TO, "TV::Activate($TV::Carrier);");
bindCommand(keyboard0, break, "r", TO, "TV::DeActivate();");
...
bindCommand(keyboard0, make, "c", TO, "kill();");
bindCommand(keyboard0, make, "3", TO, "use(\"Grenade Launcher\");");
bindCommand(keyboard0, make, "q", TO, "use(\"Beacon\");");
bindCommand(keyboard0, make, "8", TO, "use(\"Blaster\");");
bindCommand(keyboard0, make, "g", TO, "use(\"BackPack\");");
bindCommand(keyboard0, make, l_shift, "2", TO, "use(\"Mortar\");");
bindCommand(keyboard0, make, "b", TO, "AutoBuy::DumpNonLoadoutItems();");
bindCommand(mouse0, make, button0, TO, "AF::On();");
bindCommand(mouse0, break, button0, TO, "AF::Off();");
bindCommand(keyboard0, make, l_shift, "1", TO, "use(\"Laser Rifle\");");
bindCommand(mouse0, make, zaxis0, TO, "nextWeapon();");
bindCommand(keyboard0, make, "capslock", TO, "throwStart(); throwRelease(\"Grenade\");");
