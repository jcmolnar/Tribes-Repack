...
Event::Attach( eventMidAirDisc, Collector::onMidAirDisc );
Event::Attach( eventMidAirNade, Collector::onMidAirNade );
Event::Attach( eventBodyBlock, Collector::onBodyBlock );
Event::Attach( eventDamageDealt, Collector::onDamageDealt );
Event::Attach( eventTeamDamageDealt, Collector::onTeamDamageDealt );
Event::Attach( eventonNadeJump, Collector::onNadeJump );
Event::Attach( eventMidAirCK, Collector::onMidAirCK );
Event::Attach( eventFlagInterception, Collector::onFlagInt );
Event::Attach( eventFlagCatch, Collector::onFlagCatch );
Event::Attach( eventFlagClutchReturn, Collector::onFlagClutchReturn );
Event::Attach( eventFlagEGrab, Collector::onFlagEGrab );
Event::Attach( eventPlayerClunk, Collector::onPlayerClunk );
