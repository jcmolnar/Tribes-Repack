//--- export object begin ---//
instant SimGui::Control "NewMasterServerGui" {
	position = "0 0";
	extent = "640 480";
	horizSizing = "right";
	vertSizing = "bottom";
	...
	instant FearGui::FGDlgBox {
		...
		active = "True";
		messageTag = "";
		instant FearGui::TestEdit "OptionsNetworkMasterName" {
			position = "96 74";
			extent = "170 19";
			horizSizing = "right";
			vertSizing = "bottom";
			consoleVariable = "";
			consoleCommand = "OptionsNetwork::verifyMaster();";
			altConsoleCommand = "";
			deleteOnLoseContent = "True";
			ownObjects = "True";
			opaque = "False";
		...
		instant FearGui::FGUniversalButton {
			...
			isCheckbox = "False";
			radioTag = "";
			bitmapRoot = "TTL_NewMasterServer";
			isSet = "False";
		...
		instant FearGui::FGUniversalButton "DialogReturnButton" {
			...
			vertSizing = "bottom";
			consoleVariable = "";
			consoleCommand = "OptionsNetwork::newMaster();";
			altConsoleCommand = "";
			deleteOnLoseContent = "True";
			ownObjects = "True";
			opaque = "False";
		...
		instant FearGui::TestEdit "OptionsNetworkMasterAddress" {
			position = "96 110";
			extent = "170 19";
			horizSizing = "right";
			vertSizing = "bottom";
