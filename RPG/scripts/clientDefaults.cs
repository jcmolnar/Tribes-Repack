...
if($pref::packetRate == "") $pref::packetRate = 30;//was 10
if($pref::packetSize == "") $pref::packetSize = 400;//was 200
if($pref::packetFrame == "") $pref::packetFrame = 32;//was 96
if($pref::shadowDetailScale == "") $pref::shadowDetailScale = 1;//was 0
