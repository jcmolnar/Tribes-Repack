...
function StaticShape::onCollision(%this, %object) {
	...
	if(%dataname == "MaleHumanTownBot" || %dataname == "FemaleHumanTownBot" || %dataname == "cgoblin") {
		%Client = Player::getClient(%object);
		if(%Client != -1) {
			%rot = Vector::getRotation(Vector::normalize(Vector::sub(GameBase::getPosition(%object), GameBase::getPosition(%this))));
			%rot = "0 -0 "@GetWord(%rot, 2);
			GameBase::setRotation(%this, %rot);
			%mom = Vector::getFromRot(%rot, 35, 8);
			Player::applyImpulse(%Client, %mom);
		}
	}
}
...
//------------------------------------------------------------------------
StaticShapeData barrierbarrier
{
...
StaticShapeData wavywater2
{
	...
	maxDamage = 10000.0;
	isTranslucent = true;
    description = "Wavy Water 2";
   disableCollision = true;
};

StaticShapeData wavywater3
{
	shapeFile = "forcefield2";
	maxDamage = 10000.0;
	isTranslucent = true;
    description = "Wavy Water 3";
   disableCollision = true;
};
...
function StaticDoorForceField::onCollision(%this, %object)
{
	...
	%name = Client::getName(%clientId);
        ...
        if(isInGroupList(%owner, %name) || %name == %owner)
	{
		echo(%this);
...
//------------------------------------------------------------------------
//StaticShapeData horse
//{
//	shapeFile = "magcargo";
//	debrisId = defaultDebrisSmall;
//	maxDamage = 10000.0;
//	description = "ahorseisahorseofcourseofcourse";
//	isTranslucent = false;
//	disableCollision = true;
//};
...
//TOWNBOTS
StaticShapeData MaleHumanTownBot__
{
	maxDamage = 10000.0;
	isTranslucent = false;
//	disableCollision = true;
...
StaticShapeData FemaleHumanTownBot__
{
	maxDamage = 10000.0;
	isTranslucent = false;
//	disableCollision = true;
...
StaticShapeData flyer
{
	shapeFile = "flyer";
	debrisId = defaultDebrisSmall;
	maxDamage = 2.00;
	isTranslucent = true;
   	description = "Future Horse";
	visibleToSensor = true;
};

StaticShapeData csword
{
	shapeFile = "sword";
	debrisId = defaultDebrisSmall;
	maxDamage = 2.00;
	isTranslucent = true;
   	description = "Show Sword";
	visibleToSensor = true;
};
StaticShapeData invisibleman__
{
	shapeFile = "invisable";
	debrisId = defaultDebrisSmall;
	maxDamage = 9.99;
